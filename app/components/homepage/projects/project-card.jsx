...
function ProjectCard({ project }) {
  ...
  return (
    <div className="bg-card border border-card-border relative rounded-lg bg-gradient-theme w-full h-full flex flex-col hover:shadow-2xl transition-all duration-300 hover:scale-105 group">
      ...
      {/* Project Info */}
      <div className="overflow-hidden border-t-[2px] border-primary/20 px-4 lg:px-8 py-4 lg:py-8 flex-1 flex flex-col">
        <div className="mb-4">
          <h3 className="text-text-primary font-semibold text-lg mb-2">{project.name}</h3>
        ...
        {project.features && (
          <div className="mb-4">
            <h4 className="text-text-primary font-medium text-sm mb-2">Key Features:</h4>
        ...
        {/* Tools */}
        <div className="mb-4">
          <h4 className="text-text-primary font-medium text-sm mb-2">Technologies:</h4>
        ...
        <div className="mb-4">
          ...
          <span className="text-orange-400 font-medium">{project.role}</span>
        </div>
        ...
        <div className="flex gap-3 flex-wrap mt-auto">
          ...
          {project.code && (
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors duration-300 text-sm font-medium"
            >
              <FaGithub size={14} />
              Source Code
              <FaExternalLinkAlt size={12} />
